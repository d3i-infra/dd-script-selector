...
#
#     PHX_SERVER=true bin/dd_script_selector start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :dd_script_selector, DdScriptSelectorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :dd_script_selector, DdScriptSelector.Repo,
    # ssl: true,
    url: database_url,
  ...
  #
  #     config :dd_script_selector, DdScriptSelector.Mailer,
